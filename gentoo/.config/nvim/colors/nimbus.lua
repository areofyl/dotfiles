-- Nimbus colorscheme — generated by nimbus-apply
...
-- Diff
hi("DiffAdd",      { bg = "#1a2224" })
hi("DiffChange",   { bg = "#1c2028" })
hi("DiffDelete",   { fg = c.red, bg = "#241e24" })
hi("DiffText",     { bg = "#1e2428", bold = true })
